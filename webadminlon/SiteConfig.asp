...
<form method="POST" action="SiteConfig.asp" id="form" name="form">
  <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" >
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="1154" colspan="3" class="tdbg"> <input name="Sitetitle" type="text" id="Sitetitle" value="<%=Sitetitle%>" size="60" maxlength="60">      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td class="tdbg"><strong>网站关键字：</strong></td>
      <td colspan="3" class="tdbg"><input name="SKeywords" type="text" id="SKeywords" value="<%=SKeywords%>" size="60" maxlength="60"></td>
    </tr>

    <tr bgcolor="#FFFFFF"> 
      <td width="145" class="tdbg"><strong>网站概况：</strong></td>
      <td colspan="3" class="tdbg"> <input name="SDescription" type="text" id="SDescription" value="<%=SDescription%>" size="60" maxlength="50">      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
