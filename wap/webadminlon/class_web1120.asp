...
classtype=checkisint(request("classtype"),0)
  ...
  <tr>
    <td align="center" valign="middle"><strong>选择操作类型:
        ...
        <select name="nowtype" id="nowtype">
          ...
          <option value="1" <%if nowtype=1 then %>selected="selected"<% End If %>>专题类别</option>
          <option value="2" <%if nowtype=2 then %>selected="selected"<% End If %>>新闻类别</option>
          <option value="3" <%if nowtype=3 then %>selected="selected"<% End If %>>产品展示</option>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#FFFFFF"><select name="classtype" id="classtype">
      <option value="3">新闻资讯</option>
          <option value="1" <%if rsclass=1 then %>selected="selected"<% End If %>>专题类别</option>
          <option value="2" <%if rsclass=2 then %>selected="selected"<% End If %>>新闻类别</option>
          <option value="3" <%if rsclass=3 then %>selected="selected"<% End If %>>产品展示</option>
